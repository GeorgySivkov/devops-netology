...
Ответ: Т.к. hardlink и файл имеют одинаковый inode - права будут одинаковыми.
...
...
1048614 -rw-rw-r-- 2 vagrant vagrant    0 Jan 21 14:07 test_file
1048614 -rw-rw-r-- 2 vagrant vagrant    0 Jan 21 14:07 test_link
vagrant@vagrant:~$ chmod 0777 test_file
vagrant@vagrant:~$ ls -ilh
...
1048614 -rwxrwxrwx 2 vagrant vagrant    0 Jan 21 14:07 test_file
1048614 -rwxrwxrwx 2 vagrant vagrant    0 Jan 21 14:07 test_link
vagrant@vagrant:~$ 
```
...
>>> Script header accepted.
>>> Script header accepted.
>>> Created a new DOS disklabel with disk identifier 0xa229a397.
...
root@vagrant:~# vgdisplay
  ...
  VG UUID               Eshmwy-eEcY-1XO0-FcUc-1ADf-VaJi-4MgDvH
```
...
--2022-01-21 16:13:18--  https://mirror.yandex.ru/ubuntu/ls-lR.gz
Resolving mirror.yandex.ru (mirror.yandex.ru)... 213.180.204.183, 2a02:6b8::183
Connecting to mirror.yandex.ru (mirror.yandex.ru)|213.180.204.183|:443... connected.
HTTP request sent, awaiting response... 200 OK
Length: 22054724 (21M) [application/octet-stream]
Saving to: ‘/tmp/new/test.gz’

/tmp/new/test.gz                    100%[==================================================================>]  21.03M  3.13MB/s    in 5.2s    

2022-01-21 16:13:24 (4.05 MB/s) - ‘/tmp/new/test.gz’ saved [22054724/22054724]
```
...
/dev/md1:
           Version : 1.2
     Creation Time : Fri Jan 21 16:06:26 2022
        Raid Level : raid1
     ...
     Total Devices : 2
       ...
       Update Time : Fri Jan 21 16:18:06 2022
...
Consistency Policy : resync
              ...
              UUID : 51952497:c0a7cff3:928150cc:cce39940
            Events : 19
...
[  215.939882] md/raid1:md1: not clean -- starting background reconstruction
[  215.939884] md/raid1:md1: active with 2 out of 2 mirrors
[  215.939898] md1: detected capacity change from 0 to 2144337920
[  215.941546] md: resync of RAID array md1
[  226.783451] md: md1: resync done.
[  915.683820] md/raid1:md1: Disk failure on sdb1, disabling device.
